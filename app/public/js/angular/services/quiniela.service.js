        ...
        const ANALYZER_MESSAGES = {
            ...
            VISITOR: {
                ...
                ROW: {
                    ...
                    ONLY_WINS: 'Todos los partidos que ha disputado el equipo <b>{visitorTeam}</b> en la fila <b>{row}</b> han terminado en victoria local: <b>{numWins}</b>V (<b>{perWins}%</b>), <b>{numDraws}</b>E (<b>{perDraws}%</b>) y <b>{numLoses}</b>D (<b>{perLoses}%</b>).',
                    ...
                    ONLY_LOSES: 'Todos los partidos que ha disputado el equipo <b>{visitorTeam}</b> en la fila <b>{row}</b> han terminado en victoria visitante: <b>{numWins}</b>V (<b>{perWins}%</b>), <b>{numDraws}</b>E (<b>{perDraws}%</b>) y <b>{numLoses}</b>D (<b>{perLoses}%</b>).',
                    WINS_AND_DRAWS_BUT_NO_LOSES: {
